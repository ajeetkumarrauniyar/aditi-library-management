...
const Footer: React.FC<FooterProps> = ({
  companyName = "ITMS",
  description = "Streamlining library management for educational institutions. Empower your library with modern technology for student management, automated payments, and enhanced learning experiences.",
  solutions = [
    { name: "Student Management", href: "#" },
    { name: "Payment Automation", href: "#" },
  ...
  copyrightText = "© 2025 ITMS. All rights reserved.",
}) => {
  return (
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="col-span-1 md:col-span-2">
            <h3 className="gradient-text mb-4 text-2xl font-bold">{companyName}</h3>
        ...
        <div className="mt-8 border-t border-slate-700 pt-8 text-center">
          <p className="text-slate-400">{copyrightText}</p>
        </div>
      </div>
    </footer>
  );
