...
const TenantContactPage = async ({ params }: { params: { subdomain: string } }) => {
  ...
  return (
    <main className="flex h-screen flex-col items-center justify-center">
      <h1 className="text-4xl font-bold">Contact {tenant.name}</h1>
      <p className="mt-4 text-gray-600">Support & Contact Information</p>
